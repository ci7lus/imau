...
export type queryLibraryQuery = { __typename?: 'Query', viewer: { __typename?: 'User', works: { __typename?: 'WorkConnection', nodes: Array<{ __typename?: 'Work', id: string, annictId: number, malAnimeId: string | null, title: string, noEpisodes: boolean, episodes: { __typename?: 'EpisodeConnection', nodes: Array<{ __typename?: 'Episode', viewerDidTrack: boolean } | null> | null } | null } | null> | null, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, endCursor: string | null } } | null } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    queryLibrary(variables: queryLibraryQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<queryLibraryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<queryLibraryQuery>(queryLibraryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'queryLibrary');
    },
    getMe(variables?: getMeQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<getMeQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<getMeQuery>(getMeDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getMe');
    }
  };
}
